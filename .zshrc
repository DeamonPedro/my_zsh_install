...
POWERLEVEL9K_USER_BACKGROUND="233"
POWERLEVEL9K_USER_FOREGROUND="15"
...
POWERLEVEL9K_DIR_DEFAULT_BACKGROUND="30"
...
alias zshrc_up="cd ~ && git add .zshrc && git commit -m \"$(date +\"%d-%m-%y\")\" && git push"
