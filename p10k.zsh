...
set_default POWERLEVEL9K_VCS_STATE_CLEAN 'green'
set_default POWERLEVEL9K_VCS_STATE_MODIFIED 'yellow'
set_default POWERLEVEL9K_VCS_STATE_UNTRACKED 'green'
set_default POWERLEVEL9K_VCS_STATE_LOADING '233'
typeset -gA vcs_states=(
  'clean'         "${POWERLEVEL9K_VCS_STATE_CLEAN}"
  'modified'      "${POWERLEVEL9K_VCS_STATE_MODIFIED}"
  'untracked'     "${POWERLEVEL9K_VCS_STATE_UNTRACKED}"
  'loading'       "${POWERLEVEL9K_VCS_STATE_LOADING}"
)
...
function _p9k_vcs_render() {
  ...
  $2_prompt_segment "$id" "$3" "none" "$bg" '' 0 '' "${(@)_P9K_CACHE_VAL}"
  return 0
}
